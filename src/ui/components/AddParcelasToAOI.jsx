import WPSCaller from '../../functions/OGC/WPS';
import WFSCaller from '../../functions/OGC/WFS';
...
const process = async (aoi, setParcelas) => {
    ...
    const wpsendpoint = new WPSCaller();
    // 1. contorno del aoi
    const contorno = await wpsendpoint.Execute({ data });
